    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                cl.sendMessage(msg)
            elif msg.text.lower() == 'tm1':
                msg.contentType = 13
                msg.contentMetadata = {'mid': kimid}
                ki.sendMessage(msg)
            elif msg.text.lower() == 'tm2':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki2mid}
                ki2.sendMessage(msg)
            elif msg.text.lower() == 'tm3':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki3mid}
                ki3.sendMessage(msg)
            elif msg.text.lower() == 'tm4':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki4mid}
                ki4.sendMessage(msg)
            elif msg.text.lower() == 'tm5':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki5mid}
                ki5.sendMessage(msg)
            elif msg.text.lower() == 'tm6':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki6mid}
                ki6.sendMessage(msg)
            elif msg.text.lower() == 'tm7':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki7mid}
                ki7.sendMessage(msg)
            elif msg.text.lower() == 'tm8':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki8mid}
                ki8.sendMessage(msg)
            elif msg.text.lower() == 'tm9':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki9mid}
                ki9.sendMessage(msg)
            elif msg.text.lower() == 'tm10':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki10mid}
                ki10.sendMessage(msg)
            elif msg.text.lower() == 'tm18':
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki18mid}
                ki18.sendMessage(msg)
            elif msg.text.lower() == 'Sticker1':
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "16846756",
            ...
            elif msg.text.lower() == 'Tm mid':
                ki.sendText(msg.to,kimid)
            elif msg.text.lower() == 'Tm2 mid':
                ki2.sendText(msg.to,ki2mid)
            elif msg.text.lower() == 'Tm3 mid':
                ki3.sendText(msg.to,ki3mid)
            elif msg.text.lower() == 'Tm4 mid':
                ki4.sendText(msg.to,ki4mid)
            elif msg.text.lower() == 'Tm5 mid':
...
#--------------------------------------------------------
                ...
                for i in gid:
                    ...
                    ki18.leaveGroup(i)
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"PSD T&Z TEAM BOT PAMIT")
                else:
